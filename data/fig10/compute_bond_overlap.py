"""Same as compute_bond_overlap.py in ../fig4/ but for noisy aer. Code duplication to make it easy to follow the publication."""
...
SAMPLER_TYPE = "noisy_aer"  # Options: "statevector" or "noisy_aer"
NUM_SHOTS = 10_000
